    ...
    fetch('../../static/data/estadisticas_departamentos.json')
        ...
        .then(data => {
            ...
            new Chart(ctxReino, {
                type: 'pie',
                data: {
                    labels: Object.keys(data['Boyacá']['especies_por_reino']),
                    datasets: [{
                        data: Object.values(data['Boyacá']['especies_por_reino']),
            ...
            new Chart(ctxMes, {
                type: 'bar',
                data: {
                    labels: Object.keys(data['Boyacá']['registros_por_mes']),
                    datasets: [{
                        label: 'Registros por Mes',
                        data: Object.values(data['Boyacá']['registros_por_mes']),
            ...
            const registrosPorCiudad = data['Boyacá']['registros_por_ciudad'];
